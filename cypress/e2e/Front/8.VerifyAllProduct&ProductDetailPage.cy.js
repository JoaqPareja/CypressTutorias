import {header,productsPage} from '../../support/consts';
    ...
    cy.get(productsPage
      .buttonSelectFirstProduct).click();
    // 9. Verify that detail detail is visible: product name, category, price, availability, condition, brand
    cy.CheckElement(productsPage.imgViewProduct);
    cy.CheckElement(productsPage.h2ProductInformation);
    cy.get(productsPage
      .spanPriceInformation).contains('Rs'); // Checking that the price contain the right coin
